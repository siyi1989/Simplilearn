...
public class UserController {
	...
	public String displayUsers(HttpServletRequest req) {
	...
	@RequestMapping(value="/SelectedUserName", method=RequestMethod.POST)
	...
	@RequestMapping(value="/SelectedUserDate", method=RequestMethod.POST)
